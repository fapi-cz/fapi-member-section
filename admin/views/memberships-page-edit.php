            ...
            <div class="box-body">
                ...
                <table class="table-bordered">
                    <tr>
                        ...
                        <td><input type="text" name="membership_name" style="width:100%" value="<?php if( !empty( $membership['name'] ) ){ echo $membership['name']; } ?>" /></td>
                    </tr>
                    <tr>
                        <th><?php esc_attr_e( 'Note', 'fapi-membership' ); ?></th>
                        <td><textarea name="membership_note"><?php if( !empty( $membership['note'] ) ){ echo $membership['note']; } ?></textarea></td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            if( !empty( $emails->posts ) ){
                                foreach( $emails->posts as $email ){
                                    if( !empty( $membership['email'] ) && $membership['email'] == $email->ID ){ $selected = 'selected="selected"'; }else{ $selected = ''; }
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="membership_redirect" style="width:100%" value="<?php if( !empty( $membership['redirect'] ) ){ echo $membership['redirect']; } ?>" /></td>
                    </tr>
                    <tr>
                        <th><?php esc_attr_e( 'Login redirect page', 'fapi-membership' ); ?></th>
                        <td><input type="text" name="membership_login_redirect" style="width:100%" value="<?php if( !empty( $membership['login_redirect'] ) ){ echo $membership['login_redirect']; } ?>" /></td>
                    </tr>
                    <tr>
                        <th></th>
